 ...
 * @author popovicz
 */
public class ExcluirQuestao extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        daoQuestao.removePorId(Integer.parseInt(request.getParameter("id")));

        request.setAttribute("mensagem", "Tarefa excluída com sucesso !");
