 ...
 * @author popovicz
 */
@WebServlet(name = "SvCurtirComentario", urlPatterns = {"/paginas/SvCurtirComentario"})
public class SvCurtirComentario extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int alu = (Integer.parseInt(request.getParameter("id_professor")));
        boolean x = true;
        ...
        for (Curtir cur : curtidas) {
            if (cur.getProfessor() != null) {
                if (cur.getComentario().getId() == comentario.getId() && cur.getProfessor().getId() == professor.getId()) {
        ...
        if (x) {
            ...
            daoCurtir.getCurtir().setProfessor(professor);
