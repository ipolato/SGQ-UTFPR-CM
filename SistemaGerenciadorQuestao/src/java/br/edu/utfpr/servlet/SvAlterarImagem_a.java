 ...
 * @author popovicz
 */
public class SvAlterarImagem_a extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request,
        ...
        try {
            ...
            if (formItems != null && formItems.size() > 0) {
                ...
                if (aluno.getImagem().getImagem() != null) {
                    File seraApagado = new File(aluno.getImagem().getImagem());
                ...
                for (FileItem item : formItems) {
                    ...
                    if (!item.isFormField()) {
                        ...
                        String filePath = uploadPath + File.separator + aluno.getId() + fileName;
        ...
        response.sendRedirect("alterarLogin.jsp");
    }
