 ...
 * @author popovicz
 */
public class SvAlterarImagem_m extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request,
        ...
        try {
            ...
            if (formItems != null && formItems.size() > 0) {
                ...
                if (monitor.getImagem().getImagem() != null) {
                    File seraApagado = new File(monitor.getImagem().getImagem());
                ...
                for (FileItem item : formItems) {
                    ...
                    if (!item.isFormField()) {
                        ...
                        String filePath = uploadPath + File.separator + monitor.getId() + fileName;
