 ...
 * @author popovicz
 */
@WebServlet(name = "SvAlterarEmail", urlPatterns = {"/paginas/SvAlterarEmail"})
public class SvAlterarEmail extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd = request.getRequestDispatcher("trocarEmail.jsp");
