    ...
    <body>
        <div>
            ...
            <div class="col-md-10" style="margin-top: 55px">
                ...
                <form id="formulario1" action="SvComentarforum" method="post">
                    <input hidden="true" type="text" id="id_questao" name="id_questao" value="<%= questao.getId()%>">
                    <input hidden="true" type="text" id="id_professor" name="id_professor" value="<%= professor.getId()%>">
                    ...
                    <div class="form-group col-md-10">
                        ...
                        <a href="SvCurtirComentario?id_comentario=<%= c.getId()%>&id_professor=<%= professor.getId()%>&id_questao=<%= questao.getId()%>" title="Curtir comentário" style="margin:2px;">
                            ...
                            <%
                                ...
                                for (Curtir cur : curtidas) {
                                    if (cur.getComentario().getId() == c.getId()) {
                                        curtis.add(cur);
                                        if (cur.getProfessor() != null) {
                                            if (cur.getProfessor().getId() == professor.getId()) {
                                                out.print("Você ");
                                                b = true;
                                            }
                                        }
                        ...
                        <a onclick="confirmacao('<%= c.getId()%>', 'SvExcluirComentario?id=')" title="excluir comentário" style="margin:10px; text-align: right;"> <span class="glyphicon glyphicon-trash"> </span> </a>
                    </div>
                    <%     }
                        }
                    %>
